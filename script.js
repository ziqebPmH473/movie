        ...
        analysisSettings: {
            ...
            market_todayjp: {
                ...
                copyTexts: {
                    ...
                    voice: `指数動向、各ランキングから今日の東証相場を振り返り、特徴や投資家心理、市場の注目ポイントを分析してください。\nニュースは分析の材料として使い、ニュースの紹介をメインにしないこと。{{VoiceNote_Principle}}{{VoiceNote_Read}}{{VoiceNote_Basic}}{{VoiceNote_Ks}}{{VoiceNote_Size}}{{VoiceNote_tatoe}}`,
