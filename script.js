        ...
        analysisSettings: {
            ...
            market_todayjp: {
                ...
                copyTexts: {
                    ...
                    voice: `指数動向、各ランキングから今日の東証相場を振り返り、特徴や投資家心理、市場の注目ポイントを分析してください。\nニュースは分析の材料として使い、ニュースの紹介をメインにしないこと。\n日経平均とTOPIXの指数の違いについては解説しないこと。（指数の数字ではなく、指数自体の説明をしないこと）{{VoiceNote_Principle}}{{VoiceNote_Read}}{{VoiceNote_Basic}}{{nameConvert}}{{VoiceNote_Ks}}{{VoiceNote_Size}}{{VoiceNote_tatoe}}`,
