        ...
        analysisSettings: {
            ...
            market_todayjp: {
                ...
                buttonData: [
                    ...
                    { category: "【音声生成前】", services: [{ service: "notebookLM", buttons: [ { label: "音声生成", copyId: "voiceNew" },{ label: "根拠資料生成", copyId: "reportKk" }, { label: "*X・サムネ", copyId: "xNotify" }] }] },
                    ...
                    { category: "【プレゼン資料】", services: [{ service: "gamma", buttons: [{ label: "ツール文章", copyId: "presen1" },{ label: "プレゼン生成", copyId: "presentation" }] }] },
