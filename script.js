        ...
        analysisSettings: {
            market_todayjp: {
                ...
                buttonData: [
                    ...
                    { category: "【音声生成後】", services: [{ service: "notebookLM", buttons: [{ label: "ショートタイトル", copyId: "text211" }, { label: "ショート概要欄", copyId: "text212" }] }] }
                ],
                copyTexts: {
                    ...
                    text002: `各ランキングや指数動向を総合して、今日の東証相場を振り返り、特徴や投資家心理、市場の注目ポイントを分析してください。{{audioNote}}{{voiceNote}}{{upDownCorrectionNote}}{{readingNote}}`,
                    ...
                    text211: "2分で{{intro}}{{titleSBf}}先頭に「【2分で東証マーケット振り返り】」、後ろに「【{{today}}】｜AI市場分析」をつけてください。{{titleAf}}",
                    text212: `2分で{{intro}}{{SgaiyoNote}}`
                }
            },
            market_term_rank: {
            ...
            market_stock: {
                ...
                copyTexts: {
                    ...
                    text020: "{{intro}}を分析して",
                    text002: "{{intro}}を分析してください。{{audioNote}}{{voiceNote}}{{upDownCorrectionNote}}{{noticeks}}{{readingNote}}\n・レポートと株探や資料で情報が異なる場合は、株探、会社発表の資料の情報を正としてください。",
            ...
            market_buy_analysis: {
                ...
                copyTexts: {
                    ...
                    text002: "{{intro}}してください。{{audioNote}}{{voiceNote}}{{upDownCorrectionNote}}{{readingNote}}\n・レポートと株探や資料で情報が異なる場合は、株探、会社発表の資料の情報を正としてください。",
                    text004: `{{intro}}する{{reportKk}}\n・レポートと株探や資料で情報が異なる場合は、株探、会社発表の資料の情報を正としてください`,
                    text005: `{{name}}（{{ticker}}）の決算資料を分析する{{reportKk}}{{noticeks}}\n・レポートと株探や資料で情報が異なる場合は、株探、会社発表の資料の情報を正としてください`,
            ...
            market_earnings: {
                ...
                copyTexts: {
                     text001: (vars) => vars.emarket === 'jp' ? `https://kabutan.jp/stock/chart?code=${vars.ticker}\nhttps://kabutan.jp/stock/finance?code=${vars.ticker}` : `https://us.kabutan.jp/stocks/${vars.ticker}/\nhttps://us.kabutan.jp/stocks/${vars.ticker}/finance`,
                    text002: "{{intro}}してください。{{audioNote}}{{voiceNote}}{{upDownCorrectionNote}}{{noticeks}}{{readingNote}}",
                    text004: `{{intro}}する{{reportKk}}`,
                    text005: `{{name}}（{{ticker}}）の決算資料を分析する{{reportKk}}{{noticeks}}`,
...
表紙、企業概要、事業内容、企業の特長・強み、課題・懸念材料、市場の将来性、業績（直近実績）、業績（累積実績）、業績（次期予想）、業績推移、財務状況、需給環境、株価の妥当性、IPOの基本情報、投資判断、ポジティブ要因、ネガティブ要因、まとめ`,
            ...
            theme_analysis: {
                ...
                copyTexts: {
                    ...
                    text002: "{{theme}}について分析してください。{{audioNote}}{{voiceNote}}{{upDownCorrectionNote}}{{readingNote}}",
                    text004: `{{theme}}について分析する{{reportKk}}`,
                    text100: "{{theme}}について分析する{{reportSs}}",
                    text200: "{{theme}}について分析する{{thumbnail}}",
                    text201: "{{theme}}について分析する{{titleBf}}先頭に「【{{name}}({{ticker}})】」、後ろに「｜AIテーマ分析」をつけてください。{{titleAf}}",
            ...
            news: {
                 ...
                 copyTexts: {
                     text001: (vars) => vars.emarket === 'jp' ? `https://kabutan.jp/stock/chart?code=${vars.ticker}\nhttps://kabutan.jp/stock/finance?code=${vars.ticker}` : `https://us.kabutan.jp/stocks/${vars.ticker}/\nhttps://us.kabutan.jp/stocks/${vars.ticker}/finance`,
                     text020: "{{intro}}して",
                     text002: `{{intro}}ください。{{audioNote}}{{voiceNote}}{{upDownCorrectionNote}}{{readingNote}}`,
                     text004: `{{intro}}する{{reportKk}}\n・レポートと株探や資料で情報が異なる場合は、株探、会社発表の資料の情報を正としてください`,
                     text100: "{{intro}}する{{reportSs}}{{reportGc}}",
                     text200: "{{intro}}する{{thumbnail}}",
    ...
    getTemplateVariables: function(analysisKey) {
        ...
        const baseVars = {
            ...
            intro: introText,
            audioNote: this.replaceVariables(this.CONFIG.commonTemplates.audioNote, { audioLength }),
            readingNote,
            audioLength,
