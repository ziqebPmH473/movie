        ...
        analysisSettings: {
            ...
            market_todayjp: {
                ...
                copyTexts: {
                    ...
                    presenShort: `以下の流れで資料を作成して\n表紙\n国内主要株価指数（銘柄名、株価、前日比）\n・各市場（プライム、スタンダード、グロース）の出来高・時価総額\n上昇率ランキング（銘柄名、株価、前日比）\n下落率ランキング（銘柄名、株価、前日比）\n日経平均寄与度（プラス寄与）（銘柄名、証券コード、寄与度）\n日経平均寄与度（マイナス寄与）（銘柄名、証券コード、寄与度）\n売買代金ランキング（銘柄名、変動率、売買代金(百万円)）\n業種別ランキング（変動率上位）（業種名、変動率、PER）\n業種別ランキング（変動率下位）（業種名、変動率、PER）\nニュース\nまとめ\n\n・上記に記載のない項目は出力しないでください。\n・指数は小数点以下2桁まで記載してください\n・指数は大きな数字のレイアウトでまとめてください\n・ランキングは表形式にし、見出し行をつけ、上位5位まで記載して。\n・前日比を記述する場合は「変動幅\n（変動率）」の形式で記述して\n・順位は記載しない\n・寄与度ランキングは左にプラス寄与、右にマイナス寄与で１ページにして\n・業種別ランキングは左に上位、右に下位で１ページにして\n・ランキングのタイトルは上記に記載の通りとし、後ろに日付を付けたりしないで\n・売買代金の単位（百万円）は見出しに記載し、表内には記載しない。\n・表紙は、表題と、内容を4行程度の文章でまとめてください。\nただし、「この資料は」などとプレゼン資料自体の事を書かないでください\nまた、資料・動画の視聴意欲がなくならないように、結論や最も重要な内容は書かないでください。\nまとめは視覚的に理解しやすいレイアウトにしてください`,
