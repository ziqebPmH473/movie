        ...
        analysisSettings: {
            ...
            market_todayjp: {
                ...
                buttonData: [
                    ...
                    { category: "【音声生成前】", services: [{ service: "notebookLM", buttons: [ { label: "音声生成", copyId: "voiceNew" },{ label: "画像（まとめ）", copyId: "infografic" },{ label: "根拠資料生成", copyId: "reportKk" }, { label: "*X・サムネ", copyId: "xNotify" },{ label: "ツール文章", copyId: "presen1" }] }] },
