...
const App = {
    ...
    CONFIG: {
        ...
        commonTemplates: {
            ...
            CommonNote_source: "\n・出典や引用は一切記載しないこと。出典や引用についての、リンク・カッコ・番号などはすべて削除してください。",//chatGPT分析
...
表紙、企業概要、事業内容、企業の特長・強み、課題・懸念材料、市場の将来性、業績（直近実績）、業績（累積実績）、業績（次期予想）、業績推移、財務状況、需給環境、株価の妥当性、IPOの基本情報、投資判断、ポジティブ要因、ネガティブ要因、まとめ`,
            ...
            theme_analysis: {
                ...
                copyTexts: {
                    ...
                    analysis: "{{intro}}する動画の根拠資料をレポート形式で作成してください。\n動画の長さは11分なので、その長さに相応の文章量にしてください。\n動画の構成は一切考える必要はありません。{{CommonNote_source}}",
                    menberPrompt: "{{theme}}\nの動画について、以下の内容から作成しようと思いますが、問題ないですか？\n問題ない場合は、特典画像（正方形、背景白）をgeminiで作成するためのプロンプトを作成してください。geminiには以下の内容を読み込まないので、特典画像に記述する内容はすべてプロンプトに記載してください。\n\n{{textbox}}",
                    voice: "{{intro}}してください。{{VoiceNote_Principle}}{{VoiceNote_Read}}{{readingNote}}{{VoiceNote_Basic}}{{VoiceNote_Ks}}{{VoiceNote_Size}}{{VoiceNote_tatoe}}",
                    reportKk: `{{intro}}する{{reportKk}}`,
                    presentation: "{{intro}}する{{reportSs}}",
                    thumbnail: "{{intro}}する{{thumbnail}}",
