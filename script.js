...
動画で触れきれなかった補足や要点をまとめています。`
 ...
 聴き手が落ち着いて考えられる“静かな知性の語り”を生成してください。
 内容の提示が目的であり、行動や感情を促す必要はありません。
【構成ルール】
 ・冒頭は説明やテーマ名から入らず、「共感」を誘う一言で始める。
 　例：「〜って、不思議ですよね」「〜してしまうこと、ありますか？」
 ・最初の10〜15秒は、リスナーが自分に重ねられる日常的な描写にする。
 ・そこから自然に核心へ移行し、理屈より“気づき”の流れを意識する。
 ・話の展開はゆっくりと。淡々としたテンポで、焦らず進める。
 ・音量と抑揚は最小限。テンポは1秒あたり3〜3.5文字を目安。
 ・段落間に短い“間”を入れ、静けさと余韻をつくる。
 ・語尾は下げ調子で終わり、静かに閉じる。
 ・感情的な強調や驚きのトーンは禁止。
 ・締めくくりは「〜である」「〜とされている」など、事実で終える。
 ・「いかがでしたか」「考えてみてください」などの問いかけは使わない。
 ・「つまり」「次に」「ということは」「まとめると」などの接続詞は使わない。
 ・段落間は“だらだらとした自然な流れ”で、説明を区切らず静かに進行。
【文体】
 ・常体（〜である、〜とする）で統一。
 ・専門用語は避け、誰でも理解できる比喩を用いる。
 ・「心理学的には」「脳科学の観点では」などの導入は使わず、自然に視点を切り替える。
 ・理解と内省を促す静かな口調にする。
【長さ】
 ・音声時間は約3〜4分（原稿文字数800〜900字）。
 ・導入は60字以内、結びは1文で終える。
【テーマ例】
 心理・脳科学・哲学・人間行動・感情・思考など、“内面を考える”テーマ。
【禁止事項】
 ・同じ語句・語尾の繰り返し
 ・元資料や出典への言及
 ・強調語（「とても」「絶対に」など）の多用
...
【全体トーン】
 静かで知的、穏やかで落ち着いた語り。
 NHKドキュメンタリーのように、余白と間を重視する。
 聴き手が“自分の中で考える時間”を取れるように構成する。
`,
                    shortVoice: `【目的】
この音声は「AI教養ラボ」のYoutube動画用です。
